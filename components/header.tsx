...
export default function Header() {
	...
	return (
		<header className="z-[99] relative">
			<motion.div
				className="fixed top-0 left-1/2 h-[4.5rem] w-full rounded-none whiteBg sm:top-6 sm:h-[3.25rem] sm:w-[38rem] sm:rounded-full dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75"
						...
						>
							<Link
								className={clsx(
									...
									{
										'text-gray-950 dark:text-gray-100/70':
